...
def save () :
	...
	try :
		...
		Label(master,text="saved",bg='ivory2').place(x=100 , y= 120)
	except :
		Label(master,text= "already saved at " + "D:\\ss\\"+name+".avi",bg='ivory2').place(x=100, y = 120)
##############################################################################################
...
def save1() :
        ...
        try :
            ...
            Label(master,text= "already saved at " + "D:\\ss\\"+name+".png",bg='ivory2').place(x=100, y = 120)
...
b = Button(master, text="rec", command = screen_recorder, font="Algerian", bg= "white",
 activebackground="lightcyan")
Label(master, text="Screen Record",font='Engravers',bg='ivory2').place(x=0,y=10)
b.place(x=200 , y=10)
# label of screenshot button 
Label(master , text = "Screenshot",font= 'Engravers', bg='ivory2').place(x=0,y=50)
